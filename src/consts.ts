...
export const SITE_TITLE = "Raphael Ferrand";
export const SITE_DESCRIPTION =
  "Raphael Ferrand technical blog, posting about web development and programming. Learning along the way. And side-projects too 🚀";
export const SITE_URL = "https://raphaelferrand.com";
...
export const RSS_LINK_ENABLED = false;
